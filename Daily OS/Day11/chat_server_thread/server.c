...
int main(void)
{
	int    sockfd , size , y , address1[2] , address2[2] ,finsockfd1 , finsockfd2 ;  
	...
	for( ; ; )
	{
  		...
  		finsockfd1 = accept(sockfd, (struct sockaddr *)&cli_addr,(socklen_t *) &size) ;
		finsockfd2 = accept(sockfd, (struct sockaddr *)&cli_addr, (socklen_t *)&size) ;
