...
int main ()
{
  ...
  std::multiset<int> value (myints,myints+5);       // pointers used as iterators

  for (std::pair<std::multiset<int>::iterator , bool> range: value) {
      std::cout << " multiset value " << range.second ;
  }
